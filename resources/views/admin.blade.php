    ...
    <div ng-controller="AdminCtrl" class="ng-root">
        <div class='col-md-2'>
            <ul class='nav nav-pills nav-stacked admin-nav' role='tablist'>
                ...
                <li role='presentation' aria-controls="campaigns" class='admin-nav-item'><a
        ...
        <div class='col-md-10'>
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="campaigns">
                    ...
                    <form method='POST' action='/create/campaign' role='form'>
                        ...
                        <div class="form-group">
                            ...
                            <input type='text' autocomplete="off" class='form-control' name='value'/>

                        </div>

                        <input type='submit' class='btn btn-info' value='Create Campaign'/>
                        <input type="hidden" name='_token' value='{{csrf_token()}}'/>
                    </form>
                </div>
        ...
        <div class="angular-modals">
            ...
            <edit-user-api-info-modal ng-repeat="modal in modals.editUserApiInfo" user-id="modal.userId"
                                      ...
                                      clean-modals="cleanModals"></edit-user-api-info-modal>
        </div>
    </div>
